...
02. Clone the repository:
    ...
    ```console
    git clone --recursive https://github.com/haint504/prezto.git "${ZDOTDIR:-$HOME}/.zprezto"
    ```
    ...
    <details>
      ...
      - Clone the repository:
        ...
        ```console
        git clone --recursive https://github.com/haint504/prezto.git "${ZDOTDIR:-${XDG_CONFIG_HOME:-$HOME/.config}/zsh}/.zprezto"
        ```
